 <!-- Footer -->
          ...
          <div class="col-lg-8 col-md-10 mx-auto">
            <ul class="list-inline text-center">
              <li class="list-inline-item">
                <a href="https://twitter.com/OfficialOguzK">
              ...
              <li class="list-inline-item">
                <a href="http://linkedin.com/in/oğuz-kırçiçek">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
              ...
              <li class="list-inline-item">
                <a href="https://github.com/OguzKircicek">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
    ...
    <script src="<?=base_url()?>temp/assets/js/clean-blog.min.js"></script>
