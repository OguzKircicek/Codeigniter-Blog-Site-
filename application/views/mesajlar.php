    ...
    <?php  } ?>
      ...
      <div class="row">
        ...
        <div  class="box col-md-12" style="margin-left:150px">
            <a class="btn btn-success" href="<?=base_url()?>Mesajlar/mesajgonder"><i class="glyphicon glyphicon-envelope"></i> Mesaj Gönder </a>
            <a class="btn btn-info" href="<?=base_url()?>Mesajlar/gelenmesajlar"><i class="glyphicon glyphicon-envelope"></i> Gelen Mesajlar </a>
